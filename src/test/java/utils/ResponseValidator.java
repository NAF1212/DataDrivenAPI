...
public class ResponseValidator {
	...
	public static void validateFloat(Response response, String jsonPath, String expectedValue, String fieldName) {
		...
		if (actual.floatValue() != expected) {
			...
			String message = "❌ MISMATCH in " + fieldName + " | Expected: " + expected + " | Actual: " + actual;
		...
		// ✅ PASS
		String passMsg = "✅ " + fieldName + " matched | Expected: " + expected + " | Actual: " + actual;
